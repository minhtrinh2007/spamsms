...
def check_key():
    # Ngày hết hạn sử dụng (thay đổi theo nhu cầu của bạn)
    ...
    if current_date >= expiration_date:
        print("Vào telegram để update tool.")
        print("ID TELEGRAM => @figvbhvtc")
        sys.exit()
    else:
...
def send_otp_via_sapo(sdt):
    ...
    if response.status_code == 200:
        print(f" ☑ SPAM SMS {inspect.currentframe().f_code.co_name} TO {phone} => Thành Công")
    else:
        print(f" ☒ SPAM SMS {inspect.currentframe().f_code.co_name} TO {phone} => Lỗi: {response.status_code} {response.text}")
...
def send_otp_via_ACHECKIN(sdt):
    ...
    if response1.status_code == 200:
        ...
        print(f" ☒ SPAM SMS {phone} => Lỗi: {response1.status_code} {response1.text}")
    ...
    if response2.status_code == 200:
        ...
        print(f" ☒ SPAM SMS {phone} => Lỗi: {response2.status_code} {response2.text}")
    ...
    if response3.status_code == 200:
        ...
        print(f" ☒ SPAM SMS {phone} => Lỗi: {response3.status_code} {response3.text}")
...
def send_otp_via_phuclong(sdt):
    ...
    if response_check.status_code == 200:
        ...
        print(f" ☒ SPAM SMS {phone} => Lỗi: {response_check.status_code} {response_check.text}")
    ...
    if response_register.status_code == 200:
        ...
        print(f" ☒ SPAM SMS {phone} => Lỗi: {response_register.status_code} {response_register.text}")
...
def send_otp_via_takomo(sdt):
    ...
    if response_get.status_code == 200:
        ...
        print(f" ☒ SPAM SMS {phone} => Lỗi: {response_get.status_code} {response_get.text}")
    ...
    if response_post.status_code == 200:
        ...
        print(f" ☒ SPAM SMS {phone} => Lỗi: {response_post.status_code} {response_post.text}")
##################################################################################################################################################################################
##################################################################################################################################################################################
##################################################################################################################################################################################
##################################################################################################################################################################################
...
phone = input("Nhập số điện thoại cần spam: ")
delay = float(input("Nhập delay (giây) các lần gửi tin nhắn: "))
